    ...
    try {
        transporter.sendMail(mailData, function (err, info) {
            if (err) {
                ...
                let message = 'Unknown error was encountered while sending your message. Please try again after a few seconds.';
...
`);
                ...
                switch (err.code) {
                    case 'ESOCKET':
                        message = 'Could not connect to email service provider at the moment. Please try again after a few seconds.'
                    default: null
                }
